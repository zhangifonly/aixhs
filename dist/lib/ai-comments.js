 ...
 * 生成一组评论（主评论+回复）
 */
async function generateCommentGroup(noteTitle, noteContent) {
 ...
 * 生成独立评论
 */
async function generateSingleComment(noteTitle, noteContent, commenter) {
 ...
 * 为笔记生成评论
 */
export async function addAIComments(noteId, targetCount = 5) {
 ...
 * 清空所有AI评论
 */
export function clearAIComments() {
 ...
 * 批量生成评论
 */
export async function batchAddComments(minComments = 4, maxComments = 8) {
